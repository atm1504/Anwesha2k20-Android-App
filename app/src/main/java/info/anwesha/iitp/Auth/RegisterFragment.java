...
//        });
    ...
    private void register() {
        ...
        Call<info.anwesha.iitp.Auth.RegisterResponse> call = authApi.register(requestBody);

        call.enqueue(new Callback<info.anwesha.iitp.Auth.RegisterResponse>() {
            @Override
            public void onResponse(@NonNull Call<info.anwesha.iitp.Auth.RegisterResponse> call, @NonNull Response<info.anwesha.iitp.Auth.RegisterResponse> response) {
